...
void save_regs_tls(patch *actual_patch) {
    ...
    u_int8_t instructions[48] = {
        ...
        0x65, 0x48, 0x89, 0x1c, 0x25, 0x08, 0x00, 0x00, 0x00,   // mov %rbx, %gs:0x8
        0x65, 0x48, 0x89, 0x0c, 0x25, 0x10, 0x00, 0x00, 0x00    // mov %rcx, %gs:0x10
#elif MOD == 128
        0x65, 0x48, 0x89, 0x04, 0x25, 0x00, 0x00, 0x00, 0x00,       // mov %rax, %gs:0x0
        0x9f,                                                       // lahf
        0x65, 0x88, 0x24, 0x25, 0x28, 0x00, 0x00, 0x00, 	        // mov %ah, %gs:0x28
        0x65, 0x48, 0x89, 0x1c, 0x25, 0x08, 0x00, 0x00, 0x00,       // mov %rbx, %gs:0x8
        0x65, 0x48, 0x89, 0x0c, 0x25, 0x10, 0x00, 0x00, 0x00,       // mov %rcx, %gs:0x10
        0x65, 0xf3, 0x0f, 0x7f, 0x0c, 0x25, 0x18, 0x00, 0x00, 0x00  // movdqu %xmm1, %gs:0x18
#elif MOD == 256
        0x65, 0x48, 0x89, 0x04, 0x25, 0x00, 0x00, 0x00, 0x00,       // mov %rax, %gs:0x0
        0x9f,                                                       // lahf
        0x65, 0x88, 0x24, 0x25, 0x38, 0x00, 0x00, 0x00, 	        // mov %ah, %gs:0x38
        0x65, 0x48, 0x89, 0x1c, 0x25, 0x08, 0x00, 0x00, 0x00,       // mov %rbx, %gs:0x8
        0x65, 0x48, 0x89, 0x0c, 0x25, 0x10, 0x00, 0x00, 0x00,       // mov %rcx, %gs:0x10
        0x65, 0xc5, 0xfe, 0x7f, 0x0c, 0x25, 0x18, 0x00, 0x00, 0x00 // vmovdqu %ymm1, %gs:0x18
#elif MOD == 512
        0x65, 0x48, 0x89, 0x04, 0x25, 0x00, 0x00, 0x00, 0x00,                   // mov %rax, %gs:0x0
        0x9f,                                                                   // lahf
        0x65, 0x88, 0x24, 0x25, 0x58, 0x00, 0x00, 0x00, 	                    // mov %ah, %gs:0x58
        0x65, 0x48, 0x89, 0x1c, 0x25, 0x08, 0x00, 0x00, 0x00,                   // mov %rbx, %gs:0x8
        0x65, 0x48, 0x89, 0x0c, 0x25, 0x10, 0x00, 0x00, 0x00,                   // mov %rcx, %gs:0x10
